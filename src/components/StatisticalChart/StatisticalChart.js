...
class StatisticalChart extends Component {
  constructor(props) {
    ...
    this.constructProperDataFormatArea = this.constructProperDataFormatArea.bind(
      this
    );
    this.constructProperDataFormatLine = this.constructProperDataFormatLine.bind(
      this
    );
  }
  ...
  componentDidUpdate(prevProps) {
    if (this.props.isLoaded === true) {
      ...
      let dataLine = this.constructProperDataFormatLine(
        patients,
        recovered,
        dead
      );
  ...
  drawChart(dataArea, dataLine) {
    ...
    let height =
      window.innerHeight * 0.2 < 200 ? 200 : window.innerHeight * 0.3;
