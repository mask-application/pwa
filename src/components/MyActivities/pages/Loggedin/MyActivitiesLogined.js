    ...
    return (
        <>
            <AppBar position="static">
                <Toolbar>
                    <Typography variant="h6" color="inherit">ماسک
                    </Typography>
            ...
            <div className={`contentWrapper MyActivitiesWrapper`}
                 style={props.eventResult === null ? {justifyContent: "center"} : {justifyContent: "flex-start"}}>
